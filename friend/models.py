...
class FriendList(models.Model):
    ...
    def add_friend(self, account):
        ...
        # if not account in self.friends_list:
        #     self.friends_list.append(account)
    ...
    def remove_friend(self, account):
        ...
        # if account in self.friends_list:
        #     self.friends_list.remove(account)
