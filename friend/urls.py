...
from friend.views import (
    send_friend_request,
    friend_requests,
    accept_friend_request, remove_friend, decline_friend_request, cancel_friend_request, friend_list,
...
urlpatterns = [
    path('friend_decline/<friend_request_id>', decline_friend_request, name='friend-request-decline'),
    path('friend_list/<user_id>', friend_list, name='friend-list'),
